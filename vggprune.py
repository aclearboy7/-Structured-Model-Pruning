...
parser.add_argument('--model', default='/Lun2/great99/network-slimming/cifar100/weights/checkpoint.pth.tar', type=str, metavar='PATH', help='path to the model (default: none)')
