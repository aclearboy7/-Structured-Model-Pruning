...
parser.add_argument('--refine', default='./pruned model/vgg16pruned.pth.tar', type=str, metavar='PATH', help='path to the pruned model to be fine tuned. e.g. ./pruned model/xxx.pth.tar')
parser.add_argument('--param', default='./weights/vgg16_finetunewithsparsity_checkpoint.pth.tar', type=str, metavar='PATH', help='path to the model (default: none)')
parser.add_argument('--arch', default='vgg', type=str, help='architecture to use')
parser.add_argument('--percent', type=float, default=0.2, help='scale sparse rate (default: 0.5)')
...
savepath = os.path.join(args.save, "prune2.txt")
with open(savepath, "w") as fp:
    fp.write("Configuration2: \n"+str(cfg)+"\n")
...
# torch.save({'cfg': cfg, 'state_dict': newmodel.state_dict()}, os.path.join(args.save, 'pruned2.pth.tar'))
