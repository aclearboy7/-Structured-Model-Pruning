...
savepath = os.path.join(args.save, "denseprune.txt")
...
torch.save({'cfg':cfg, 'stat_dict': newmodel.state_dict()}, os.path.join(args.save, 'dense40_'+ str(args.percent) +'_pruned.pth.tar'))
